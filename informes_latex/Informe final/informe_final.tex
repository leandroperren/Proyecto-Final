...
\begin{enumerate}
	...
	\item Programación en plataforma Android.
\end{enumerate}
...
La utilización de funciones de recorte permite acentuar los máximos temporales de la señal (correspondientes al periodo fundamental), de forma que la discriminación del período fundamental se visualize con mayor claridad en el tramo analizado.
