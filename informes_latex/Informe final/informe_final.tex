...
\rhead{\textit{\footnotesize Ingeniería Informática}}
% Footer
...
Para ello se presenta un método basado en el cálculo del $T_0$ por medio de la autocorrelacion, este método recorrerá por ventaneo en tiempo real toda la  señal capturada por el dispositivo y determinará si el $T_0$ de esa ventana cae dentro de un rango determinado para que sea considerado ronquido. Este rango de $T_0$ se determina mediante la extracción de una gran cantidad de ronquidos de señales limpias de formato *EDF provistas por un especialista de trastornos de sueño y que  contienen la grabación de toda una noche de sueño, 6 o 7 horas de duración, correspondientes a personas de ambos sexos. \\
