...
\title{{\color{light-grey} TESIS DE GRADO}\\ \Huge{\textbf{Desarrollo de métodos inteligentes para la detección y clasificación de ronquidos\\ CAMBIAR!}}}
\author{
Meurzet, Matias$^{1}$, Perren, Leandro$^{2}$\\ \\
...
%
%==============================================================================
\chapter{Método de detección de ronquidos por medio de Pitch($T_0$)}
