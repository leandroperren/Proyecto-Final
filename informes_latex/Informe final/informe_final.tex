...
\begin{itemize}
	...
	\item En el capítulo 2 se describe el método de detección desarrollado en esta tesis. Primeramente se describe la extracción de ronquidos y calculo del $T_0$ de las señales limpias EDF y se determina en base a ellos un rango de decisión. Para finalizar se presentan las tasas de acierto del algoritmo detector desarrollado en Matlab utilizando las señales limpias EDF.
