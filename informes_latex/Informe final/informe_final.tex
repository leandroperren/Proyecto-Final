...
Por el lado de la aplicación Android, esta permitirá capturar una señal digital por medio del micrófono del dispositivo, la cual será analizada tomando ventanas de 5 minutos determinando si en dicho segmento se producen ronquidos. La aplicación permitirá acceder a dos tipos de reportes, uno gráfico y otro en modo texto donde se presentarán los resultados. En ellos se indicarán la hora en que se producirán los eventos y una estimación de la intesidad determinando dos niveles. A su vez la aplicación permitirá enviar via correo electrónico estos reportes a un médico que pudiera estar interesado en los análisis.
